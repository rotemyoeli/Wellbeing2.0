...
const SECTION_META: { id: Exclude<Section, null>; icon: React.ReactNode; gradient: string }[] = [
  { id: 'org', icon: <SvgIcon d="M3 21h18M9 8h1M9 12h1M9 16h1M14 8h1M14 12h1M14 16h1M5 21V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16" />, gradient: 'from-accent-700 to-accent-500' },
  { id: 'users', icon: <SvgIcon d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2M9 7a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM23 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75" />, gradient: 'from-teal-700 to-teal-500' },
  { id: 'depts', icon: <SvgIcon d="M2 20h20M4 20V10l8-6 8 6v10M10 20v-6h4v6" />, gradient: 'from-accent-900 to-accent-700' },
  { id: 'policies', icon: <SvgIcon d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />, gradient: 'from-teal-500 to-accent-500' },
  { id: 'data', icon: <SvgIcon d="M18 20V10M12 20V4M6 20v-6" />, gradient: 'from-accent-700 to-teal-700' },
  { id: 'system', icon: <SvgIcon d="M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z" />, gradient: 'from-ink-700 to-accent-900' },
]
...
function SvgIcon({ d }: { d: string }): React.ReactElement {
